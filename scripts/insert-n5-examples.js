...
const n5Examples = {
  ...
  円: [
    ...
    },
    {
      ...
      word_breakdown: [{ word: "円い", reading: "まるい", meaning: "bundar" }],
    },
  ],
  年: [
    {
  ...
  食: [
    ...
    },
    {
      ...
      word_breakdown: [{ word: "食事", reading: "しょくじ", meaning: "makan" }],
    },
  ],
  飲: [
    {
...
async function insertN5Examples() {
  try {
    ...
    console.log(
      `\n✅ Successfully inserted ${inserted} examples for ${
        inserted / 2
      } kanji!`
    );
    if (skipped > 0) {
