...
const advancedExamples = {
  ...
  '爆': [
    ...
    },
    {
      ...
      word_breakdown: [
        ...
        { word: '大爆笑', reading: 'だいばくしょう', meaning: 'tertawa terbahak-bahak' }
      ]
    }
  ],
  '片': [
  ...
  '甘': [
    ...
    },
    {
      ...
      word_breakdown: [
        ...
        { word: 'はいけません', reading: 'はいけません', meaning: 'tidak boleh' }
      ]
    }
  ],
  '砂': [
  ...
  '壱': [
    {
      ...
      word_breakdown: [
        ...
        { word: '壱万円', reading: 'いちまんえん', meaning: 'sepuluh ribu yen (legal)' }
      ]
    },
    {
  ...
  '扱': [
    ...
    },
    {
      ...
      word_breakdown: [
        { word: '取扱説明書', reading: 'とりあつかいせつめいしょ', meaning: 'manual/petunjuk' },
  ...
  '維': [
    ...
    },
    {
      ...
      word_breakdown: [
        ...
        { word: '発展しました', reading: 'はってんしました', meaning: 'berkembang' }
      ]
    }
  ],
  '緯': [
    ...
    },
    {
      ...
      word_breakdown: [
        ...
        { word: '説明します', reading: 'せつめいします', meaning: 'menjelaskan' }
      ]
    }
  ]
};
...
async function insertAdvancedExamples() {
  ...
  try {
    ...
    console.log(`📝 Found ${kanjiWithoutExamples.length} N2/N1 kanji without examples\n`);
    ...
    console.log(`\n✅ Successfully inserted ${insertCount} examples for ${(insertCount/2)} kanji!`);
    if (skippedCount > 0) {
      console.log(`⚠️  Skipped ${skippedCount} kanji (no examples defined yet)`);
    }
