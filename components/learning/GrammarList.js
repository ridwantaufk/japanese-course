            ...
            >
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  ...
                  {g.audio_url && (
                    <button
                      onClick={(e) => { e.stopPropagation(); playAudio(g.audio_url, `pattern-${g.id}`, g.pattern); }}
            ...
            {expandedId === g.id && (
              <div className="p-6 pt-0 border-t border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-black/20">
                <div className="mt-4 space-y-4">
                  ...
                  {g.example_sentence && (
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">Examples</h4>
                      <div className="space-y-3">
                        <div className="bg-white dark:bg-black/40 p-4 rounded-xl border border-slate-200 dark:border-white/10">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            {g.example_audio_url && (
                              <button
                                onClick={() => playAudio(g.example_audio_url, `example-${g.id}`, g.example_sentence)}
